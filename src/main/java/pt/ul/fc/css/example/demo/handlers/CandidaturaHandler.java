...
public class CandidaturaHandler {
  ...
  public CandidaturaDTO newCandidatura(
    ...
    return new CandidaturaDTO(
        new_candidatura.getId(),
        new_candidatura.getTema().getId(),
        new_candidatura.getDataCandidatura(),
        new_candidatura.getEstado().name(),
        -1,
        new_candidatura.getAluno().getId());
  }

  public void addTeseToCandidatura(Integer teseID, Integer candidaturaID)
  ...
  public CandidaturaDTO updateCandidaturaStatus(Integer candidaturaID, String estado)
      throws NotPresentException {
