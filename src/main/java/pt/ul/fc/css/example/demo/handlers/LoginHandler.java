...
public class LoginHandler {
  ...
  public UtilizadorEmpresarialDTO registerUtilizadorEmpresarial(
    ...
    Optional<UtilizadorEmpresarial> currentUtilizadorEmpresarial =
        utilizadorEmpresarialRepository.findByEmail(email);
  ...
  public DocenteDTO loginDocente(String email) throws NotPresentException {
    ...
    if (optCurrentDocente.isPresent()) {
      ...
      DocenteDTO docenteDTO =
          new DocenteDTO(
              currentDocente.getId(),
              currentDocente.getName(),
              currentDocente.getEmail(),
              currentDocente.getDepartamento(),
              currentDocente.isAdmnistrador(),
              getTemasIds(currentDocente.getTemasPropostos()),
