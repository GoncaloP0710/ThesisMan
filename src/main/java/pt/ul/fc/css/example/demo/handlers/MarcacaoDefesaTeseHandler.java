...
public class MarcacaoDefesaTeseHandler {
  ...
  public MarcacaoDefesaTeseHandler(
  ...
  public void marcarDefesaDissertacaoPropostaTese(
      Integer docenteId, Integer teseId, Date data, Boolean online, String room, Integer arguenteId)
    ...
    if (!tese.getCandidatura().getTema().getSubmissor().getId().equals(docenteId)) {
