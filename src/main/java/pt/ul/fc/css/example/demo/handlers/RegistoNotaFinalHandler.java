...
public class RegistoNotaFinalHandler {
  ...
  public void registarNotaFinal(Integer teseID, Integer docenteId, Integer nota)
    ...
    if (!(presidente.getId() == docenteId)) {
      throw new IllegalArgumentException(
          "O utilizador que se está a tentar registar a nota não é o presidente");
    }
