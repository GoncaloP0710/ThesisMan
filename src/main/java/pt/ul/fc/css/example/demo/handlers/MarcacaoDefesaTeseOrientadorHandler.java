...
//     public void marcarDefesaPresencialTese(Integer teseID, String emailDocente, Integer presidenteId, 
//                                 Integer arguenteId, Integer docenteOrientadorId, boolean isPresencial, 
...
//             if(defesa.isFinal()) {
//                 throw new IllegalArgumentException("Já existe uma defesa (final) de proposta marcada");
//             }
//         }
...
//             Optional<Juri> optJuri = juriRepository.findByJuri(arguente, docenteOrientador, presidente);
//             Juri juri = null;

//             if (optJuri.isEmpty()) {
//                 juri = new Juri(presidente, arguente, docenteOrientador);
