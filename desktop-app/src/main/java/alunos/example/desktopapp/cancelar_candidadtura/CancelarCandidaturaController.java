package alunos.example.desktopapp.cancelar_candidadtura;
...
public class CancelarCandidaturaController {
	...
	@FXML
	private Button deleteCandidatura;
	...
	public void deleteCandidatura() throws Exception {
		...
		if(RestAPIClientService.getInstance().cancelarCandidatura(Integer.valueOf(currentTema.getCol1()))) {
		} else {
			Alert alert = new Alert(Alert.AlertType.ERROR);
			alert.setTitle("Erro");
